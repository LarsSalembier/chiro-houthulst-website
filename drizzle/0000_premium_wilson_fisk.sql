...
CREATE TABLE IF NOT EXISTS "chirohouthulst-website_addresses" (
	...
	CONSTRAINT "chirohouthulst-website_addresses_street_house_number_box_municipality_postal_code_unique" UNIQUE("street","house_number","box","municipality","postal_code")
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "chirohouthulst-website_members" (
	...
	"created_at" timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
	"updated_at" timestamp with time zone,
	CONSTRAINT "chirohouthulst-website_members_first_name_last_name_date_of_birth_unique" UNIQUE("first_name","last_name","date_of_birth")
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "chirohouthulst-website_parents" (
	...
	"created_at" timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
	"updated_at" timestamp with time zone,
	CONSTRAINT "chirohouthulst-website_parents_first_name_last_name_address_id_unique" UNIQUE("first_name","last_name","address_id")
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "chirohouthulst-website_work_years" (
	...
	"created_at" timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
	"updated_at" timestamp with time zone,
	CONSTRAINT "chirohouthulst-website_work_years_start_date_end_date_unique" UNIQUE("start_date","end_date")
);
--> statement-breakpoint
