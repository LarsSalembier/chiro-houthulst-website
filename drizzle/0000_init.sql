...
CREATE TABLE IF NOT EXISTS "chirohouthulst-website_event_groups" (
	...
	CONSTRAINT "chirohouthulst-website_event_groups_event_id_group_name_pk" PRIMARY KEY("event_id","group_name")
);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "chirohouthulst-website_event_registrations" (
	...
	"created_at" timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
	"updated_at" timestamp with time zone,
	CONSTRAINT "chirohouthulst-website_event_registrations_event_id_member_id_pk" PRIMARY KEY("event_id","member_id")
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "chirohouthulst-website_members_parents" (
	...
	CONSTRAINT "chirohouthulst-website_members_parents_member_id_parent_email_address_pk" PRIMARY KEY("member_id","parent_email_address")
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "chirohouthulst-website_sponsors" (
	"company_name" varchar(256) PRIMARY KEY NOT NULL,
...
CREATE TABLE IF NOT EXISTS "chirohouthulst-website_sponsorship_agreements" (
	...
	"created_at" timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
	"updated_at" timestamp with time zone,
	CONSTRAINT "chirohouthulst-website_sponsorship_agreements_sponsor_company_name_work_year_id_pk" PRIMARY KEY("sponsor_company_name","work_year_id")
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "chirohouthulst-website_yearly_memberships" (
	...
	"created_at" timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
	"updated_at" timestamp with time zone,
	CONSTRAINT "chirohouthulst-website_yearly_memberships_member_id_group_name_work_year_id_pk" PRIMARY KEY("member_id","group_name","work_year_id")
);
--> statement-breakpoint
DO $$ BEGIN
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "chirohouthulst-website_event_groups" ADD CONSTRAINT "chirohouthulst-website_event_groups_group_name_chirohouthulst-website_groups_name_fk" FOREIGN KEY ("group_name") REFERENCES "public"."chirohouthulst-website_groups"("name") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "chirohouthulst-website_members" ADD CONSTRAINT "chirohouthulst-website_members_address_id_chirohouthulst-website_addresses_id_fk" FOREIGN KEY ("address_id") REFERENCES "public"."chirohouthulst-website_addresses"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "chirohouthulst-website_members_parents" ADD CONSTRAINT "chirohouthulst-website_members_parents_parent_email_address_chirohouthulst-website_parents_email_address_fk" FOREIGN KEY ("parent_email_address") REFERENCES "public"."chirohouthulst-website_parents"("email_address") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "chirohouthulst-website_sponsorship_agreements" ADD CONSTRAINT "chirohouthulst-website_sponsorship_agreements_sponsor_company_name_chirohouthulst-website_sponsors_company_name_fk" FOREIGN KEY ("sponsor_company_name") REFERENCES "public"."chirohouthulst-website_sponsors"("company_name") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "chirohouthulst-website_yearly_memberships" ADD CONSTRAINT "chirohouthulst-website_yearly_memberships_group_name_chirohouthulst-website_groups_name_fk" FOREIGN KEY ("group_name") REFERENCES "public"."chirohouthulst-website_groups"("name") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
